import PageLayout 			from "../fungi/PageLayout.js";
import * as THREE			from "./three.module.js";

import Ecs, { Components }	from "../fungi/Ecs.js";
import RenderLoop			from "../fungi/RenderLoop.js"

import InputTracker 		from "../fungi/InputTracker.js";
	...
	class Builder{
		...
		///////////////////////////////////////////////////////
			...
			render_loop( cb=null ){
				...
				this.add( async()=>{
					await import( "../fungi/RenderLoop.js").then( mod=>{ App.loop = new mod.default( App.render, 0, App ) });
					App.loop.start();
					return true;
				});
				return this;
